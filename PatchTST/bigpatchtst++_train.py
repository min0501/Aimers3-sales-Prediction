...
CFG = {
    "TRAIN_WINDOW_SIZE": 128,  # 128일치로 학습
...
model.load_state_dict(
    torch.load("./ckpt/bigpatchtst_2.pth"), strict=False
)  # Load saved model
...
torch.save(infer_model.state_dict(), "./ckpt/bigpatchtst_3.pth")
